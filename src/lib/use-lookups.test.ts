...
describe("date and time display formatters", () => {
  ...
  it("formats timestamps as DD/MM/YYYY HH:MM in 24-hour time", () => {
    expect(formatDateTime("2026-07-10T18:45:00+05:30")).toBe("10/07/2026 18:45");
    expect(formatDateTime("2026-07-10T00:05:00+05:30")).toBe("10/07/2026 00:05");
  });
