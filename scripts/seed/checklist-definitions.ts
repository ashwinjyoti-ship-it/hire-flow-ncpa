...
export const CHECKLIST_DEFINITIONS: ChecklistDefSeed[] = [
  ...
  { module: "operations", section: "Financials", field_key: "installment_1_expected_date", label: "Installment 1 — Expected Date", field_type: "date", visibility_rule: "onlyWhen(instalment == Yes)", triggers_task: { rule: "instalment", title: "Follow up: Installment 1", due_after_days: 0, complete_when: "installment received checkbox is ticked" } },
  { module: "operations", section: "Financials", field_key: "installment_1_received", label: "Installment 1 — Received", field_type: "checkbox", visibility_rule: "onlyWhen(instalment == Yes)" },
  { module: "operations", section: "Financials", field_key: "installment_2_expected_date", label: "Installment 2 — Expected Date", field_type: "date", visibility_rule: "onlyWhen(instalment == Yes)", triggers_task: { rule: "instalment", title: "Follow up: Installment 2", due_after_days: 0, complete_when: "installment received checkbox is ticked" } },
  { module: "operations", section: "Financials", field_key: "installment_2_received", label: "Installment 2 — Received", field_type: "checkbox", visibility_rule: "onlyWhen(instalment == Yes)" },
  { module: "operations", section: "Financials", field_key: "installment_3_expected_date", label: "Installment 3 — Expected Date", field_type: "date", visibility_rule: "onlyWhen(instalment == Yes)", triggers_task: { rule: "instalment", title: "Follow up: Installment 3", due_after_days: 0, complete_when: "installment received checkbox is ticked" } },
  { module: "operations", section: "Financials", field_key: "installment_3_received", label: "Installment 3 — Received", field_type: "checkbox", visibility_rule: "onlyWhen(instalment == Yes)" },
  { module: "operations", section: "Financials", field_key: "installment_4_expected_date", label: "Installment 4 — Expected Date", field_type: "date", visibility_rule: "onlyWhen(instalment == Yes)", triggers_task: { rule: "instalment", title: "Follow up: Installment 4", due_after_days: 0, complete_when: "installment received checkbox is ticked" } },
  { module: "operations", section: "Financials", field_key: "installment_4_received", label: "Installment 4 — Received", field_type: "checkbox", visibility_rule: "onlyWhen(instalment == Yes)" },
  { module: "operations", section: "Financials", field_key: "installment_5_expected_date", label: "Installment 5 — Expected Date", field_type: "date", visibility_rule: "onlyWhen(instalment == Yes)", triggers_task: { rule: "instalment", title: "Follow up: Installment 5", due_after_days: 0, complete_when: "installment received checkbox is ticked" } },
  { module: "operations", section: "Financials", field_key: "installment_5_received", label: "Installment 5 — Received", field_type: "checkbox", visibility_rule: "onlyWhen(instalment == Yes)" },
